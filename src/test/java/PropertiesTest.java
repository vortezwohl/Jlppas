...
public class PropertiesTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File g_file = new File(basePath + "\\competition\\properties\\properties-g");
        ...
        File x_file = new File(basePath + "\\competition\\properties\\properties-x");
        ...
        File g_x_file = new File(basePath + "\\competition\\properties\\properties-g_x");
